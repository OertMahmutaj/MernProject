        ...
        <>
            ...
            <section className="bg-gray-50 dark:bg-gray-900">
                <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto lg:py-0">
                    <a href="/products" className="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
                        Pharma
                    </a>
                    <img className='rounded-full w-29 h-30 p-4' src={userData.profilePicture} alt="" />
                    <div>
                        <input
                            type="file"
                            id="profile-picture"
                            ...
                            className='block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 m-4'
                        />
